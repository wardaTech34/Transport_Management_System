...
5. Warda Yousaf  - SP23-BSE-042  -  REGISTRATION LOGIN DASHBORD
6. 
7. Kashmala Zeb  - SP23-BSE-048  -  Finance ( Manage fee structure, Generate Fee challan, Collect Payment, User Dashboard)
8. Tehreem Jilani- SP23-BSE-041  -  Finance ( Track Defaulters, Refund Handling, Security and logs)
9. Sarina Amjad  - SP22-BSE-095    Register
